 ...
 * Custom React hooks for AI chat with the Groq API
 */
...
/**
 * Main hook for calling Groq API via serverless proxy
 * Handles loading state, errors, and API configuration
 */
export const useGroq = () => {
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState<string | null>(null);

  const isConfigured = !!import.meta.env.VITE_GROQ_API_KEY || typeof window !== 'undefined';
...
/**
 * Utility function for safe Groq calls with error handling
 */
