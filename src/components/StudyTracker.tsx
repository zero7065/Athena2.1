...
const StudyTracker: React.FC = () => {
  ...
  useEffect(() => { sendNotification('ATHENA Ready', 'Start your study session!'); }, []);
  ...
  return (
    <div className="p-3 sm:p-5 md:p-8 space-y-4 sm:space-y-6 h-full flex flex-col max-w-full overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 flex-1 overflow-hidden">
        <div className="lg:col-span-2 glass p-5 sm:p-8 md:p-12 rounded-[24px] sm:rounded-[40px] flex flex-col items-center justify-center relative overflow-hidden min-h-[350px] sm:min-h-[400px]">
